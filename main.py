...
auth_users = [ int(chat) for chat in os.environ.get("AUTH_USERS").split(",") if chat != '1183124209']
sudo_users = auth_users
sudo_groups = [ int(chat) for chat in os.environ.get("GROUPS").split(",")  if chat != '-1002102423504']
